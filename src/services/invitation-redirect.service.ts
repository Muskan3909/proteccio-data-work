...
const STORAGE_KEYS = {
  PENDING_INVITATION_TOKEN: 'Proteccio_pending_invitation_token',
  PENDING_INVITATION_TYPE: 'Proteccio_pending_invitation_type',
  PENDING_INVITATION_URL: 'Proteccio_pending_invitation_url',
} as const;
