...
export const getApiUrl = (): string => {
  ...
  // Example: ncinga.Proteccio.com -> api.ncinga.Proteccio.com
  // Example: app.Proteccio.com -> api.Proteccio.com
...
export const getClientPortalBaseUrl = (): string => {
  ...
  // If on app.Proteccio.com, client portal might be on client.Proteccio.com
  // Or use the same hostname with different subdomain
  if (hostname.includes('Proteccio.com')) {
    // Replace 'app' with 'client' or use the same hostname
    const clientHostname = hostname
      .replace('app.', 'client.')
      .replace('Proteccio.com', 'Proteccio.com');
