  ...
  const profile: MenuProps['items'] = [
    {
      ...
      label: (
        ...
        >
          {isOwnerOrAdmin && (
            <Link to="/Proteccio/admin-center/overview" style={getLinkStyle()}>
              {t('adminCenter')}
            </Link>
          )}
          {!isLicenseExpired && (
            <Link to="/Proteccio/settings/profile" style={getLinkStyle()}>
              {t('settings')}
            </Link>
          )}
          {isLicenseExpired && (
            <Link to="/Proteccio/settings/account-deletion" style={getDangerLinkStyle()}>
              {t('deleteAccount')}
            </Link>
          )}
