...
export const CsvMappingStepsContent: React.FC<CsvMappingStepsContentProps> = ({
  ...
  const fieldLabelByValue = React.useMemo(() => {
    ...
    ProteccioFieldOptions.forEach(option => {
  ...
  const buildMappingOptions = React.useCallback(
    (columnName: string) => {
      ...
      return [
        ...ProteccioFieldOptions.map(option => ({
          value: option.value,
          label: option.label,
        })),
        {
      ...
      <div style={{ width: '100%' }}>
        ...
        <Typography.Text style={{ color: palette.textSecondary, display: 'block', marginBottom: 12 }}>
          {t('importStep.customColumnHint', {
            defaultValue:
              'Need a custom column? Type a new name in the Proteccio field box while mapping.',
          })}
        </Typography.Text>
        ...
        >
          ...
          >
            ...
            <span style={{ flex: 2 }}>
              {t('importStep.ProteccioFields', { defaultValue: 'Proteccio fields' })}
            </span>
      ...
      <div style={{ width: '100%' }}>
        ...
        <Typography.Paragraph style={{ color: palette.textSecondary, marginBottom: 16 }}>
          {t(
            ...
            'Build more structure into your space by mapping values in your Status column to Proteccio statuses.'
          )}{' '}
          <a
            href="https://Proteccio.com/blog/"
            target="_blank"
        ...
        >
          ...
          <span style={{ flex: 2, display: 'flex', alignItems: 'center' }}>
            ...
            {t('importStep.ProteccioWorkTypes', { defaultValue: 'Proteccio statuses' })}
          </span>
        </div>
    ...
    return (
      <div style={{ width: '100%' }}>
        <Typography.Title level={3} style={{ color: palette.text, marginBottom: 16 }}>
          {t('importStep.moveUsersToProteccio', { defaultValue: 'Move users to Proteccio' })}
        </Typography.Title>
          ...
          <>
            ...
            >
              ...
              <span style={{ flex: 3 }}>
                ...
                {t('importStep.usersMovingToProteccio', {
                  defaultValue: 'Users moving to Proteccio ({{count}})',
