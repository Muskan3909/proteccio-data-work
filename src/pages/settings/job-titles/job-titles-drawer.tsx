...
import { evt_settings_job_titles_create } from '@/shared/Proteccio-analytics-events';
    ...
    try {
      ...
      if (jobTitleId) {
        ...
        if (response.done) {
          ...
          message.error(response.message || t('updateJobTitleErrorMessage'));
        }
      } else {
        ...
        if (response.done) {
          ...
          message.error(response.message || t('createJobTitleErrorMessage'));
        }
      }
    } catch (error) {
