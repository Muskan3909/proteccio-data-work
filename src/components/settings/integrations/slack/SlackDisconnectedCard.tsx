        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed max-w-sm mx-auto">
            {t('notConnected.description', {
              defaultValue:
                'Integrate Slack with your Proteccio team to receive real-time notifications, create tasks from Slack, and keep your team synchronized across both platforms.',
            })}
          </p>
        </div>
