...
class HubSpotManager {
  constructor() {
    this.isProduction = window.location.hostname === 'app.protecciodata.com';
  ...
  injectDarkModeCSS() {
    ...
    style.textContent = `
      ...
      */
      ...
      /* Ensure Proteccio app elements are not affected by HubSpot styles */
      .ant-menu,
      .ant-menu *,
      [class*="settings"],
      [class*="sidebar"],
      .proteccio-app *:not([id*="hubspot"]):not([class*="widget"]) {
