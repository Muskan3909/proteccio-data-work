...
import { evt_schedule_page_visit } from '@/shared/proteccio-analytics-events';
...
const Schedule: React.FC = () => {
  ...
  return (
    <div className="proteccio-schedule-page" style={{ minHeight: '90vh' }}>
      <Flex align="center" justify="space-between">
        ...
        >
          <Button className="proteccio-schedule-control" onClick={handleToday}>
            {t('today', { defaultValue: 'Today' })}
          </Button>
          <Space>
            <Select
              className="proteccio-schedule-select"
              value={type}
            ...
            <div className="proteccio-schedule-date-picker">
        ...
        <Space>
          <Button
            className="proteccio-schedule-icon-control"
            icon={<ReloadOutlined />}
