...
const ClientPortalRequestDetails = () => {
  ...
  const handleCreateInvoice = () => {
    navigate(`/proteccio/client-portal/invoices/create?requestId=${id}`);
  };
              ...
              {invoices.map((invoice: any) => {
                ...
                return (
                  <Card
                    ...
                    size="small"
                    hoverable
                    onClick={() => navigate(`/proteccio/client-portal/invoices/${invoice.id}`)}
                    style={{
                      cursor: 'pointer',
                      borderRadius: 8,
                      border: `1px solid ${token.colorBorderSecondary}`,
      ...
      <Flex align="center" justify="space-between" style={{ width: '100%' }}>
        <Flex gap={12} align="center">
          <Button
            ...
            onClick={() => navigate('/proteccio/client-portal/requests')}
          />
