  ...
  const chatData = React.useMemo(() => {
    try {
      if (messages && Array.isArray(messages) && messages.length > 0) {
        ...
        const currentUserId = (window as any).__Proteccio_USER__?.id;
    ...
    <Flex vertical flex={1} style={{ height: '100%', overflow: 'hidden' }}>
      ...
      <Flex
        ...
        style={{
          ...
          backgroundColor: themeWiseColor('#fff', '#0B1221', themeMode),
        }}
      >
      ...
      >
        {pendingFile && (
          <Flex
            ...
            style={{
              padding: '6px 20px',
              backgroundColor: themeWiseColor('#f5f5f5', '#131B27', themeMode),
              fontSize: 12,
            }}
          >
            <PaperClipOutlined />
