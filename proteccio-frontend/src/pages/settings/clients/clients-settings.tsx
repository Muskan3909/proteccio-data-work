...
import { evt_settings_clients_visit } from '@/shared/proteccio-analytics-events';
...
const ClientsSettings: React.FC = () => {
  ...
  return (
    <Card
      style={{ width: '100%', maxWidth: 1120, margin: '24px auto 0' }}
      title={
        <Flex justify="flex-end">
          ...
          >
            <Input
              ...
              style={{ flex: '1 1 auto', width: 0, minWidth: 0 }}
            ...
            <Tooltip title={t('pinTooltip')} trigger={'hover'}>
              <span style={{ flexShrink: 0 }}>
                <PinRouteToNavbarButton
                  name="clients"
                  path="/proteccio/settings/clients"
                  adminOnly={true}
                />
              </span>
            </Tooltip>
