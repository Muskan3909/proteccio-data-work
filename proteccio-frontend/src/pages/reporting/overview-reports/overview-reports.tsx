...
import { evt_reporting_overview } from '@/shared/proteccio-analytics-events';
...
const OverviewReports = () => {
  ...
  return (
    <Flex className="proteccio-report-overview" vertical gap={24}>
      <CustomPageHeader title={t('overviewTitle')} children={headerChildren} />

      <OverviewStats />

      <Card className="proteccio-report-teams-panel">
