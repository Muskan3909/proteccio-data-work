...
const LicenseExpired = () => {
  ...
  const handleUpgrade = async () => {
    if (subscriptionType === ISUBSCRIPTION_TYPE.CUSTOM) {
      ...
      navigate('/proteccio/admin-center/billing');
    }
  };
...
<span>{getUpgradeText()}</span>
          ...
          <button
            onClick={() => navigate('/proteccio/admin-center/billing')}
            style={{
              width: '100%',
              height: 44,
              borderRadius: 10,
      ...
      <div style={{ marginTop: 20, textAlign: 'center' }}>
        <Text style={{ fontSize: 13, color: footerColor }}>
          ...
          <a href="mailto:support@protecciodata.com" style={{ color: footerLinkColor, textDecoration: 'none' }}>
