...
const ReportingLayout = () => {
  ...
  return (
    <ConfigProvider wave={{ disabled: true }}>
      <Layout className="proteccio-reporting-layout" style={{ minHeight: '100vh' }}>
        <Layout.Header
        ...
        <Layout className="proteccio-reporting-shell" style={{ marginTop: 64 }}>
          <Layout.Sider
            trigger={null}
            collapsible
          ...
          <Layout
            style={{
              marginLeft: isCollapsed ? 80 : 246,
              transition: 'margin-left 0.2s cubic-bezier(0.645, 0.045, 0.355, 1)',
            }}
          >
            <Layout.Content className="proteccio-reporting-content" style={{ padding: 32, minHeight: 'calc(100vh - 64px)' }}>
              <Outlet />
            </Layout.Content>
          </Layout>
        </Layout>
