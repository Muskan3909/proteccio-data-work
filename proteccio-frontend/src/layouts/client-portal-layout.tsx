...
import { evt_client_portal_viewed } from '@/shared/proteccio-analytics-events';
...
const ClientPortalLayout = () => {
  ...
  if (!hasBusinessAccess) {
    return <Navigate to="/proteccio/admin-center/billing" replace />;
  }
  ...
  return (
    <Layout
      style={{
        minHeight: '100vh',
        background: themeWiseColor('#fafafa', '#0B1221', themeMode),
      }}
    >
      {/* Fixed Header */}
      <Layout.Header
