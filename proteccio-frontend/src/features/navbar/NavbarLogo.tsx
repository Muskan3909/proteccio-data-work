...
const NavbarLogo = () => {
  ...
  return (
    <Link to={'/proteccio/home'}>
      <div className="proteccio-brand-lockup">
        {logoSrc === defaultLogo && !isChristmasSeason ? (
          <>
            <img className="proteccio-brand-mark" src={proteccioIcon} alt={t('logoAlt')} />
            <span className="proteccio-brand-name">proteccio</span>
          </>
        ) : (
          <img
            src={logoSrc}
