...
import proteccioLogoLight from '@/assets/images/logo.png';
import proteccioLogoDark from '@/assets/images/logo-dark-mode.png';

// logos
export const LOGO_LIGHT = proteccioLogoLight;
export const LOGO_DARK = proteccioLogoDark;
// Christmas variants fall back to the standard Proteccio Data logo until
// dedicated seasonal artwork is provided.
export const XMAS_LOGO_LIGHT = proteccioLogoLight;
export const XMAS_LOGO_DARK = proteccioLogoDark;
...
export const FILTER_INDEX_KEY = 'proteccio.projects.filter_index';
export const DISPLAY_MODE_KEY = 'proteccio.projects.display_as';
export const Proteccio_REDIRECT_PROJ_KEY = 'proteccio.redirect_proj';
export const PROJECT_SORT_FIELD = 'proteccio.projects.sort_field';
export const PROJECT_SORT_ORDER = 'proteccio.projects.sort_order';
export const PROJECT_LIST_COLUMNS = 'proteccio.reporting.projects.column_list';
...
export const ProteccioColorCodes = [
