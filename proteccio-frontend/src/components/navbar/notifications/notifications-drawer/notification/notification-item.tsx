...
interface NotificationItemProps {
  notification: IProteccioNotification;
  isUnreadNotifications?: boolean;
  markNotificationAsRead?: (id: string) => Promise<void>;
  goToUrl?: (e: React.MouseEvent, notification: IProteccioNotification) => Promise<void>;
}
...
const NotificationItem = ({
  ...
  return (
    <div
      ...
      className="ant-notification-notice Proteccio-notification rounded-4"
    >
