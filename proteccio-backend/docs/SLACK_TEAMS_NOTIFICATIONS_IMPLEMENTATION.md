...
**File:** `Proteccio-backend/src/services/external-notifications.service.ts`
...
**File:** `Proteccio-backend/src/services/teams-notification.service.ts`
...
### 1. Slack Service
**File:** `Proteccio-backend/src/services/slack.service.ts`
...
**File:** `Proteccio-backend/src/socket.io/commands/on-quick-task.ts`
...
**Files:** 
- `Proteccio-backend/src/socket.io/commands/on-quick-assign-or-remove.ts`
- `Proteccio-backend/src/socket.io/commands/on-task-assignees-change.ts`
...
**File:** `Proteccio-backend/src/socket.io/commands/on-task-status-change.ts`
...
**File:** `Proteccio-backend/.env.template`
...
4. Connect workspace through Proteccio UI
