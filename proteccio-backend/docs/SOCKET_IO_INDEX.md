...
- Introduction to Socket.IO in Proteccio
- Quick start guide
- Common use cases
- Key concepts
...
3. Backend Source: `Proteccio-backend/src/socket.io/`
...
### Backend Source Code
- Socket.IO implementation: `Proteccio-backend/src/socket.io/`
- Event definitions: `Proteccio-backend/src/socket.io/events.ts`
- Command handlers: `Proteccio-backend/src/socket.io/commands/`
