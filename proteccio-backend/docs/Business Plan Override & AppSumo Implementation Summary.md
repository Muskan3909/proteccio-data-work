...
### Migration File
**Location:** `Proteccio-backend/database/migrations/release-v2.5/20260316000000-add-business-plan-overrides.sql`
...
1. **Run Database Migration**
   ```bash
   psql -U cdsadmin -d Proteccio_db -f Proteccio-backend/database/migrations/release-v2.5/20260316000000-add-business-plan-overrides.sql
   ```

2. **Update `deserialize_user` Function**
   ```bash
   psql -U cdsadmin -d Proteccio_db -f Proteccio-backend/database/sql/4_functions.sql
   ```
