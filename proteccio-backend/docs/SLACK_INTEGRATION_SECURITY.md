...
```bash
# Apply the migration
psql -U your_user -d Proteccio_db -f Proteccio-backend/database/migrations/20250130000001-create-slack-integration.sql
```

This creates the following tables:
- `slack_workspaces` - Stores encrypted Slack workspace credentials
- `slack_users` - Maps Slack users to Proteccio users
