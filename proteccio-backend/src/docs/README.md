# Proteccio API Documentation Guide

This guide explains how to access, update, and maintain the Proteccio API documentation using OpenAPI 3.0 and Swagger UI.
...
```
Proteccio-backend/src/docs/openapi.yaml
```
...
openapi-generator-cli generate \
  ...
  -g typescript-axios \
  -o ../Proteccio-frontend/src/api-client
```
