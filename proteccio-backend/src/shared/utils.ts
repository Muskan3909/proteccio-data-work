...
import { AvatarNamesMap, NumbersColorMap, ProteccioColorCodes } from "./constants";
...
export function isTestServer() {
  ...
  return hostname === "dev.protecciodata.com" || hostname === "uat.app.protecciodata.com";
}
...
export function getRandomColorCode() {
  ...
  return ProteccioColorCodes[~~(Math.random() * ProteccioColorCodes.length)];
}
