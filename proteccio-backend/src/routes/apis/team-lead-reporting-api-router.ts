 ...
 */
teamLeadReportingApiRouter.get("/team-leads-with-members", teamOwnerOrAdminValidator, safeControllerFunction(async (req: IProteccioRequest, res: IProteccioResponse) => {
  try {
 ...
 */
teamLeadReportingApiRouter.get("/team-lead-members/:teamLeadId", teamOwnerOrAdminValidator, idParamValidator, safeControllerFunction(async (req: IProteccioRequest, res: IProteccioResponse) => {
  try {
    const teamId = req.user?.team_id;
 ...
 */
teamLeadReportingApiRouter.get("/team-lead-hierarchy", teamOwnerOrAdminValidator, safeControllerFunction(async (req: IProteccioRequest, res: IProteccioResponse) => {
  try {
    const teamId = req.user?.team_id;
 ...
 */
teamLeadReportingApiRouter.get("/team-lead-performance/:teamLeadId", teamOwnerOrAdminValidator, idParamValidator, safeControllerFunction(async (req: IProteccioRequest, res: IProteccioResponse) => {
  try {
    const teamId = req.user?.team_id;
    const teamLeadId = req.params.id;
 ...
 */
teamLeadReportingApiRouter.get("/team-lead-time-logs/:teamLeadId", teamOwnerOrAdminValidator, idParamValidator, safeControllerFunction(async (req: IProteccioRequest, res: IProteccioResponse) => {
  try {
    const teamId = req.user?.team_id;
    const teamLeadId = req.params.id;
