...
export default class TeamsController extends ProteccioControllerBase {
  @HandleExceptions()
  ...
  @HandleExceptions()
  public static async getTeamInvites(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const q = `
      SELECT id,
             team_id,
             team_member_id,
  ...
  @HandleExceptions()
  public static async activate(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
