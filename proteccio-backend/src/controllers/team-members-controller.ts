...
export default class TeamMembersController extends ProteccioControllerBase {
  ...
  private static async ensureManageableTarget(
    ...
    if (!targetRoleName) {
      return new ServerResponse(false, null, "Team member not found.") as unknown as IProteccioResponse;
    }
  ...
  public static async exportAllMembers(
    ...
    const fileName = `Proteccio - Team Members Export - ${exportDate}`;
    const metadata = {};
    const title = "";
