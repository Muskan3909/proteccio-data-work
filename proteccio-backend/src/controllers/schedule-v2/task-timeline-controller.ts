...
export default class TaskTimelineController extends ProteccioControllerBase {
    /**
     ...
     */
    @HandleExceptions()
    public static async getTasksForTimeline(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
     ...
     */
    @HandleExceptions()
    public static async getTaskConflicts(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
        const { taskId } = req.params;
