...
export default class CapacityController extends ProteccioControllerBase {
    /**
     * Get daily capacity for all team members in date range
     * GET /api/schedule-gannt-v2/capacity/daily
     */
    @HandleExceptions()
    public static async getDailyCapacity(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
     ...
     */
    @HandleExceptions()
    public static async getCapacitySummary(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
     ...
     */
    @HandleExceptions()
    public static async getCapacityConflicts(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
        const { startDate, endDate } = req.query as {
            startDate?: string;
            endDate?: string;
        };
