...
export default class TimeOffController extends ProteccioControllerBase {
    /**
     * Get time-off entries for team members
     * Supports filtering by member and date range
     */
    @HandleExceptions()
    public static async getTimeOff(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
     ...
     */
    @HandleExceptions()
    public static async createTimeOff(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
     ...
     */
    @HandleExceptions()
    public static async updateTimeOff(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
        const { id } = req.params;
     ...
     */
    @HandleExceptions()
    public static async deleteTimeOff(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
        const { id } = req.params;
     ...
     */
    @HandleExceptions()
    public static async getTimeOffSummary(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
