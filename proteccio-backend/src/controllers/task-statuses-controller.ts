...
export default class TaskStatusesController extends ProteccioControllerBase {
  ...
  @HandleExceptions()
  public static async getCreated(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getCategories(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async updateName(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const q = `
        UPDATE task_statuses
        SET name = $2
        WHERE id = $1
  ...
  @HandleExceptions()
  public static async updateCategory(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async updateStatusOrder(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
