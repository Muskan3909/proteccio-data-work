...
export default class AdminActiveTeamOwnersController extends ProteccioControllerBase {
  
  @HandleExceptions()
  public static async getMostActiveTeamOwners(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getActiveTeamOwnersSummary(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const query = `
      WITH team_owners AS (
        SELECT 
          t.id as team_id,
  ...
  @HandleExceptions()
  public static async exportActiveTeamOwners(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
