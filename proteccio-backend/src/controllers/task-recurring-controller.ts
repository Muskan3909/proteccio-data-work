...
export default class TaskRecurringController extends ProteccioControllerBase {
  @HandleExceptions()
  ...
  @HandleExceptions()
  public static async updateSchedule(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { id } = req.params;
    const { 
      schedule_type, 
      days_of_week, 
