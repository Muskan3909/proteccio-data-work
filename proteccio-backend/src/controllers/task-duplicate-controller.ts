...
export default class TaskDuplicateController extends ProteccioControllerBase {
  /**
  ...
  @HandleExceptions()
  public static async duplicate(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
