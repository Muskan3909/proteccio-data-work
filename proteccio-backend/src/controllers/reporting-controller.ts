...
export default class ReportingController extends ProteccioControllerBase {
  @HandleExceptions()
  ...
  @HandleExceptions()
  public static async getEstimatedVsActualTime(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getReportingOverviewStats(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getReportingProjectStats(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { includeArchived } = req.query;
  ...
  @HandleExceptions()
  public static async getReportingTeams(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { includeArchived } = req.query;
    const q = `SELECT t.id,
                      t.name,
                      (SELECT COUNT(*)
  ...
  @HandleExceptions()
  public static async getProjectsByTeam(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getEstimatedVsLogged(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { includeArchived } = req.query;
    const q = `SELECT t.id,
                      t.name,
                      (SELECT SUM(time_spent)
  ...
  @HandleExceptions()
  public static async getAllocation(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const teams = (req.body.teams || []) as string[]; // ids
    // Use SqlHelper.buildInClause for safe IN clause
    const { clause: teamIdsClause, params: teamIdsParams } = SqlHelper.buildInClause(teams, 1);
  ...
  @HandleExceptions()
  public static async getMyTeams(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getCategoriesByTeams(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getProjectsByTeams(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async exportOverviewExcel(req: IProteccioRequest, res: IProteccioResponse): Promise<void> {
  ...
  @HandleExceptions()
  public static async exportAllocation(req: IProteccioRequest, res: IProteccioResponse): Promise<void> {
  ...
  @HandleExceptions()
  public static async getActiveProjects(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { includeArchived } = req.query;
    const q = `SELECT id,
                      name,
                      updated_at,
  ...
  @HandleExceptions()
  public static async getOverdueProjects(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { includeArchived } = req.query;
    const q = `SELECT id,
                      name,
                      updated_at,
  ...
  @HandleExceptions()
  public static async getReportingCustom(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { includeArchived } = req.query;
  ...
  @HandleExceptions()
  public static async getProjectDetailsById(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async exportProjects(req: IProteccioRequest, res: IProteccioResponse): Promise<void> {
  ...
  @HandleExceptions()
  public static async getUnAssignedUsers(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getMembersWithOverDueTasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getReportingMemberStats(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { includeArchived } = req.query;
  ...
  @HandleExceptions()
  public static async getReportingMemberOverview(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { includeArchived } = req.query;
  ...
  @HandleExceptions()
  public static async getMemberProjects(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getTasksByProject(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getReportingMembersTasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { memberId, teamId } = req.query;
    if (!teamId || !memberId) return res.status(200).send(new ServerResponse(true, []));
  ...
  @HandleExceptions()
  public static async getProjectsByTeamId(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getReportingMembers(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getProjectsByMember(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async exportMembers(req: IProteccioRequest, res: IProteccioResponse): Promise<void> {
  ...
  @HandleExceptions()
  public static async getHoursLoggedForProject(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
