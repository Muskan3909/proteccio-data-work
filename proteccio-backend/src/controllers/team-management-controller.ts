...
export default class TeamManagementController {
  public static async assignManager(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    try {
  ...
  public static async bulkAssignMembers(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    try {
  ...
  public static async removeManagerAssignment(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    try {
  ...
  public static async getTeamHierarchy(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    try {
      const teamId = req.user?.team_id;
