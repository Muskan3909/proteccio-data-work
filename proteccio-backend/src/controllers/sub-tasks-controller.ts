...
export default class SubTasksController extends ProteccioControllerBase {
  @HandleExceptions()
  public static async getNames(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getSubTasksRoadMap(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
