...
export default class AwsSesController extends ProteccioControllerBase {
  @HandleExceptions()
  public static async handleBounceResponse(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async handleComplaintResponse(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async handleReplies(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    return res.status(200).send(new ServerResponse(true, null));
  }

  @HandleExceptions()
  public static async handleDeliveryEvents(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    try {
