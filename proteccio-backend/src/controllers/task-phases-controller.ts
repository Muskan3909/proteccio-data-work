...
export default class TaskPhasesController extends ProteccioControllerBase {
  ...
  @HandleExceptions()
  public static async updateSortOrder (req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const body = {
