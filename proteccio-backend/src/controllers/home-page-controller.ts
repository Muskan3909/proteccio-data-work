...
export default class HomePageController extends ProteccioControllerBase {
  ...
  @HandleExceptions()
  public static async createPersonalTask(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getTasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
...
if (isCalendarView != "true") {
  ...
  @HandleExceptions()
  public static async getTaskCountsByMonth(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const teamId = req.user?.team_id;
    const userId = req.user?.id;
  ...
  @HandleExceptions()
  public static async getPersonalTasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async updatePersonalTask(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const q = `
