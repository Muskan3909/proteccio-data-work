...
import { HTML_TAG_REGEXP, getPublicStorageUrl } from "../shared/constants";
...
export default class TaskCommentsController extends ProteccioControllerBase {
  ...
  private static async sendMail(config: IMailConfig) {
    ...
    const taskUrl = `${getBaseUrl()}/proteccio/projects/${config.projectId}?tab=tasks-list&task=${config.taskId}&focus=comments`;
    const settingsUrl = `${getBaseUrl()}/proteccio/settings/notifications`;
  ...
  public static async create(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    ...
    const url = `${getPublicStorageUrl()}/${getRootDir()}`;
  ...
  @HandleExceptions()
  public static async getByTaskId(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async deleteAttachmentById(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const q = `DELETE
  ...
  @HandleExceptions()
  public static async updateReaction(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { id } = req.params;
  ...
  @HandleExceptions()
  public static async createAttachment(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    req.body.user_id = req.user?.id;
    req.body.team_id = req.user?.team_id;
  ...
  @HandleExceptions()
  public static async download(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
