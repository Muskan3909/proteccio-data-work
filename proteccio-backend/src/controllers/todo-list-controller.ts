...
export default class TodoListController extends ProteccioControllerBase {
  @HandleExceptions()
  ...
  @HandleExceptions()
  public static async updateStatus(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async updateIndex(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
