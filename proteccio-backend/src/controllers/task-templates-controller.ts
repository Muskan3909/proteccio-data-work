...
export default class TasktemplatesController extends ProteccioControllerBase {
  @HandleExceptions({
    raisedExceptions: {
  ...
  @HandleExceptions()
  public static async import(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const {id} = req.params;
