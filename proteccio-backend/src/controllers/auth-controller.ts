...
export default class AuthController extends ProteccioControllerBase {
  /** This just send ok response to the client when the request came here through the sign-up-validator */
  public static async status_check(_req: IProteccioRequest, res: IProteccioResponse) {
    return res.status(200).send(new ServerResponse(true, null));
  }

  public static async checkPasswordStrength(req: IProteccioRequest, res: IProteccioResponse) {
    const result = PasswordStrengthChecker.validate(req.query.password as string);
    return res.status(200).send(new ServerResponse(true, result));
  }

  public static verify(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  public static logout(req: IProteccioRequest, res: IProteccioResponse) {
    req.logout((err) => {
      if (err) {
  ...
  @HandleExceptions()
  public static async changePassword(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  public static async reset_password(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  @HandleExceptions({ logWithError: "body" })
  public static async verify_reset_email(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  @HandleExceptions({ logWithError: "body" })
  public static async verifyCaptcha(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  public static googleMobileAuthPassport(req: IProteccioRequest, res: IProteccioResponse, next: NextFunction) {
   ...
   */
  public static appleMobileAuthPassport(req: IProteccioRequest, res: IProteccioResponse, next: NextFunction) {
    const mobileOptions = {
      session: true,
      failureFlash: true,
      failWithError: false
  ...
  @HandleExceptions({ logWithError: "body" })
  public static async googleMobileAuth(req: IProteccioRequest, res: IProteccioResponse) {
