...
export default class ProjectPrioritiesController extends ProteccioControllerBase {
  @HandleExceptions()
  ...
  @HandleExceptions()
  public static async getById(_req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
