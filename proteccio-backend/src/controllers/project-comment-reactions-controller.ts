...
export default class ProjectCommentReactionsController extends ProteccioControllerBase {

  @HandleExceptions()
  public static async addReaction(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async removeReaction(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { comment_id, emoji } = req.body;
    const userId = req.user?.id;
  ...
  @HandleExceptions()
  public static async getReactions(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async editComment(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getEditHistory(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { comment_id } = req.params;
