...
export default class ProjectInsightsController extends ProteccioControllerBase {
  @HandleExceptions()
  ...
  public static async getMemberInsightsByProjectId(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const {archived} = req.query;
  ...
  @HandleExceptions()
  public static async getLastUpdatedtasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { archived } = req.query;
  ...
  @HandleExceptions()
  public static async getProjectLogs(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getStatusOverview(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const {archived} = req.query;
  ...
  @HandleExceptions()
  public static async getPriorityOverview(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const {archived} = req.query;
  ...
  @HandleExceptions()
  public static async getOverdueTasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const {archived} = req.query;
  ...
  @HandleExceptions()
  public static async getTasksFinishedEarly(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const {archived} = req.query;
  ...
  @HandleExceptions()
  public static async getTasksFinishedLate(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const {archived} = req.query;
  ...
  @HandleExceptions()
  public static async getTasksByProjectMember(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getProjectDeadlineStats(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const {archived} = req.query;
  ...
  @HandleExceptions()
  public static async getOverloggedTasksByProject(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const {archived} = req.query;
