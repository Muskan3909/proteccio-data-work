...
export default class ProjectMembersController extends ProteccioControllerBase {
  ...
  public static async createByEmail(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    req.body.user_id = req.user?.id;
    req.body.team_id = req.user?.team_id;
  ...
  @HandleExceptions()
  public static async generateProjectInvitationLink(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async validateProjectInvitationLink(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async acceptProjectInvitationByLink(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { token } = req.params;
  ...
  @HandleExceptions()
  public static async revokeProjectInvitationLink(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getProjectInvitationLinkStatus(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
