...
export default class WorkloadGanntController extends WLTasksControllerBase {
  ...
  @HandleExceptions()
  public static async getMembers(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  // @HandleExceptions()
  // public static async getTasksByTeamMeberId(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
