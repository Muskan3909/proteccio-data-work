...
export default class CustomcolumnsController extends ProteccioControllerBase {
  @HandleExceptions()
  ...
  @HandleExceptions()
  public static async getProjectColumns(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
