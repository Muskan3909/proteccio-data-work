...
export default class ClientsController extends ProteccioControllerBase {
  ...
  @HandleExceptions()
  public static async addSubscriber(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    ...
    return res.status(200).send(new ServerResponse(true, null, "Thank you for subscribing. We'll update you once Proteccio is live!"));
  }
}
