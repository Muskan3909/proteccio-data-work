...
export default class ProjectsController extends ProteccioControllerBase {
  ...
  @HandleExceptions()
  public static async updatePinnedView(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getMyProjectsToTasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getMyProjects(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getMembersByProjectId(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async updateBudget(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const budget = Number(req.body.budget);
    if (!Number.isFinite(budget) || budget < 0) {
      return res.status(400).send(new ServerResponse(false, null, "Budget must be 0 or greater"));
    }

    const result = await db.query(
      `UPDATE projects SET budget = $1, updated_at = CURRENT_TIMESTAMP
       WHERE id = $2 AND team_id = $3 RETURNING id, budget, currency`,
      [budget, req.params.id, req.user?.team_id || null]
    );
    if (!result.rows.length) return res.status(404).send(new ServerResponse(false, null, "Project not found"));
    return res.status(200).send(new ServerResponse(true, result.rows[0]));
  }

  @HandleExceptions()
  public static async updateCurrency(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const currency = req.body.currency?.toString().trim().toLowerCase();
    if (!currency) return res.status(400).send(new ServerResponse(false, null, "Currency is required"));

    const result = await db.query(
      `UPDATE projects SET currency = $1, updated_at = CURRENT_TIMESTAMP
       WHERE id = $2 AND team_id = $3 RETURNING id, budget, currency`,
      [currency, req.params.id, req.user?.team_id || null]
    );
    if (!result.rows.length) return res.status(404).send(new ServerResponse(false, null, "Project not found"));
    return res.status(200).send(new ServerResponse(true, result.rows[0]));
  }
  ...
  @HandleExceptions()
  public static async getOverview(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const q = `
  ...
  @HandleExceptions()
  public static async getOverviewMembers(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getAllTasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getAllProjects(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async toggleFavorite(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async toggleArchive(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async toggleArchiveAll(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getGrouped(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
