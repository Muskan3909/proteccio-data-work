...
export default class PersonalOverviewController extends ProteccioControllerBase {
  @HandleExceptions()
  public static async getTasksDueToday(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const q = `
        SELECT id,
              name,
  ...
  @HandleExceptions()
  public static async getTasksRemaining(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const q = `
    SELECT id,
          name,
          (SELECT name FROM projects WHERE project_id = projects.id) AS project_name,
  ...
  @HandleExceptions()
  public static async getTaskOverview(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const q = `
    SELECT id,
     name,
     color_code,
  ...
  @HandleExceptions()
  public static async getCompletedTasksTodayPercentage(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
