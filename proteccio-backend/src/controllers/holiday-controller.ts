...
export default class HolidayController extends ProteccioControllerBase {
  @HandleExceptions()
  public static async getHolidayTypes(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getOrganizationHolidays(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async createOrganizationHoliday(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async updateOrganizationHoliday(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { id } = req.params;
  ...
  @HandleExceptions()
  public static async deleteOrganizationHoliday(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const { id } = req.params;
  ...
  @HandleExceptions()
  public static async getCountryHolidays(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getAvailableCountries(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async importCountryHolidays(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getHolidayCalendar(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async populateCountryHolidays(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
