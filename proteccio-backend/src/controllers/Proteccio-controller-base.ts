...
export default abstract class ProteccioControllerBase {
  ...
  protected static isValidHost(hostname: string) {
    return hostname === "Proteccio.com"
      || hostname === "www.Proteccio.com"
      || hostname === "dev.Proteccio.com"
      || hostname === "uat.Proteccio.com";
  }
