...
export default class ReportingMembersController extends ReportingControllerBaseWithTimezone {
  ...
  protected static getCurrentTeamId(req: IProteccioRequest): string | null {
  ...
  @HandleExceptions()
  public static async export(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  @HandleExceptions()
  public static async exportTimeLogs(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  @HandleExceptions()
  public static async exportActivityLogs(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  @HandleExceptions()
  public static async getMemberActivities(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getMemberTimelogs(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getMemberTaskStats(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getTimelogsFlat(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async exportTimelogsFlatCSV(req: IProteccioRequest, res: IProteccioResponse): Promise<void> {
  ...
  private static parseTimelogExportQueryParams(req: IProteccioRequest): ParsedTimelogExportQueryParams {
   ...
   */
  private static async getTimelogsFlatData(req: IProteccioRequest, team_member_id?: string, duration?: string, date_range?: string, billable?: string, search?: string): Promise<any> {
    // Get the team_id from request user
    const teamId = req.user?.team_id;
  ...
  @HandleExceptions()
  public static async exportTimelogsFlatExcel(req: IProteccioRequest, res: IProteccioResponse): Promise<void> {
    const { teamMemberId, duration, dateRange, billable, search } = this.parseTimelogExportQueryParams(req);
...
@HandleExceptions()
public static async getSingleMemberProjects(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  @HandleExceptions()
  public static async exportMemberProjects(req: IProteccioRequest, res: IProteccioResponse) {
