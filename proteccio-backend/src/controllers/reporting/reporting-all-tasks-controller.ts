...
export default class ReportingAllTasksController extends ReportingControllerBase {
  ...
  private static buildWhereClause(req: IProteccioRequest, body: IAllTasksRequest, values: any[]): string {
  ...
  @HandleExceptions()
  public static async getReportingAllTasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async exportExcel(req: IProteccioRequest, res: IProteccioResponse) {
    const body: IAllTasksRequest = req.body;
  ...
  @HandleExceptions()
  public static async exportCSV(req: IProteccioRequest, res: IProteccioResponse) {
    const body: IAllTasksRequest = req.body;
  ...
  private static async getTasksData(req: IProteccioRequest, body: IAllTasksRequest) {
