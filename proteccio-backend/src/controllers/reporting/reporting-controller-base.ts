...
export default abstract class ReportingControllerBase extends ProteccioControllerBase {
   ...
   */
  public static async buildProjectFilterForTeamLead(req: IProteccioRequest): Promise<string> {
