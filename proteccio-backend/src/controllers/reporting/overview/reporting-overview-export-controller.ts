...
export default class ReportingOverviewExportController extends ReportingOverviewBase {
  ...
  @HandleExceptions()
  public static async getProjectsByTeamOrMember(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  @HandleExceptions()
  public static async getMembersByTeam(req: IProteccioRequest, res: IProteccioResponse) {
    const teamId = (req.query.team_id as string)?.trim() || null;
    const teamName = (req.query.team_name as string)?.trim() || null;
  ...
  @HandleExceptions()
  public static async exportProjectMembers(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  @HandleExceptions()
  public static async exportProjectTasks(req: IProteccioRequest, res: IProteccioResponse) {
    const projectId = (req.query.project_id as string)?.trim() || null;
    const projectName = (req.query.project_name as string)?.trim() || null;
    const teamName = (req.query.team_name as string)?.trim() || "";
  ...
  @HandleExceptions()
  public static async exportMemberTasks(req: IProteccioRequest, res: IProteccioResponse) {
  ...
  @HandleExceptions()
  public static async exportProjectMemberTasks(req: IProteccioRequest, res: IProteccioResponse) {
    const teamMemberId = (req.query.team_member_id as string)?.trim() || null;
    const teamMemberName = (req.query.team_member_name as string)?.trim() || null;
    const projectId = (req.query.project_id as string)?.trim() || null;
    const projectName = (req.query.project_name as string)?.trim() || null;
  ...
  @HandleExceptions()
  public static async exportFlatTasks(req: IProteccioRequest, res: IProteccioResponse) {
    const teamMemberId = (req.query.team_member_id as string)?.trim() || null;
    const teamMemberName = (req.query.team_member_name as string)?.trim() || null;
    const projectId = (req.query.project_id as string)?.trim() || null;
    const projectName = (req.query.project_name as string)?.trim() || null;
