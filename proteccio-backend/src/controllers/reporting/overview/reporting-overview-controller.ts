...
export default class ReportingOverviewController extends ReportingOverviewBase {
  @HandleExceptions()
  public static async getStatistics(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getTeams(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const teamId = this.getCurrentTeamId(req);
    const includeArchived = req.query.archived === "true";
  ...
  @HandleExceptions()
  public static async getProjects(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getProjectsByTeamOrMember(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getMembersByTeam(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const teamId = req.params.team_id?.trim() || null;
    const archived = req.query.archived === "true";
  ...
  @HandleExceptions()
  public static async getProjectOverview(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getProjectMembers(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getProjectTasksPaginated(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const projectId = req.params.project_id?.trim() || null;
  ...
  @HandleExceptions()
  public static async getTeamMemberOverview(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getMemberOverview(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const teamMemberId = req.query.teamMemberId as string;
  ...
  @HandleExceptions()
  public static async getMemberTasks(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getTeamOverview(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
