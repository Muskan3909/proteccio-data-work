...
export default class TeamLeadMembersController extends ReportingControllerBase {
   ...
   */
  public static async getTeamLeadsWithManagedMembers(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    try {
   ...
   */
  public static async getManagedMembersByTeamLead(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    try {
      const teamId = req.user?.team_id;
      const userId = req.user?.id;
   ...
   */
  public static async getTeamLeadHierarchy(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    try {
      const teamId = req.user?.team_id;
      const userId = req.user?.id;
