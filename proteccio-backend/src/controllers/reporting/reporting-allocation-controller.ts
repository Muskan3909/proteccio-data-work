...
export default class ReportingAllocationController extends ReportingControllerBase {
  ...
  @HandleExceptions()
  public static async getProjectTimeSheets(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getMemberTimeSheets(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const archived = req.query.archived === "true";
  ...
  @HandleExceptions()
  public static async exportTest(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getEstimatedVsActual(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const archived = req.query.archived === "true";
