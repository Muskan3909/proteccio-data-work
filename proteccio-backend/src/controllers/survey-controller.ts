...
export default class SurveyController extends ProteccioControllerBase {
  @HandleExceptions()
  public static async getAccountSetupSurvey(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const q = `
      SELECT 
        s.id,
        s.name,
  ...
  @HandleExceptions()
  public static async submitSurveyResponse(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
  ...
  @HandleExceptions()
  public static async getUserSurveyResponse(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const userId = req.user?.id;
  ...
  @HandleExceptions()
  public static async checkAccountSetupSurveyStatus(req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
    const userId = req.user?.id;
