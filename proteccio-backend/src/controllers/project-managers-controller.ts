...
export default class ProjectManagersController extends ProteccioControllerBase {
  @HandleExceptions()
  public static async getByOrg(_req: IProteccioRequest, res: IProteccioResponse): Promise<IProteccioResponse> {
