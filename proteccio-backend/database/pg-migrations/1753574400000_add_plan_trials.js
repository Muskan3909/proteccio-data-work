...
GRANT SELECT, INSERT, UPDATE ON licensing_plan_trials TO Proteccio_db_user;
GRANT EXECUTE ON FUNCTION can_start_plan_trial TO Proteccio_db_user;
GRANT EXECUTE ON FUNCTION start_plan_trial TO Proteccio_db_user;
GRANT EXECUTE ON FUNCTION get_active_plan_trial TO Proteccio_db_user;
  `);
};
