...
-- Grant permissions to Proteccio_client role
GRANT SELECT ON client_portal_services_view TO Proteccio_client;
GRANT SELECT ON client_portal_requests_view TO Proteccio_client;
GRANT SELECT ON client_portal_invoices_view TO Proteccio_client;
GRANT SELECT ON client_relationships_view TO Proteccio_client;
GRANT SELECT ON client_portal_chat_messages_view TO Proteccio_client;
GRANT SELECT ON client_portal_projects_view TO Proteccio_client;
GRANT SELECT ON client_portal_stats_view TO Proteccio_client;
GRANT SELECT ON client_portal_permissions_view TO Proteccio_client; 
  `);
};
