...
CREATE TABLE IF NOT EXISTS slack_users (
    ...
    user_id           UUID,                                                        -- Proteccio user ID (nullable for unmapped users)
...
-- Create slack_channel_configs table to link Proteccio projects with Slack channels
...
CREATE TABLE IF NOT EXISTS slack_notifications (
    ...
    Proteccio_entity_type TEXT,                                                         -- e.g., 'task', 'project', 'comment'
    Proteccio_entity_id   UUID,
...
CREATE INDEX IF NOT EXISTS idx_slack_notifications_entity ON slack_notifications(Proteccio_entity_type, Proteccio_entity_id);
