...
psql -d Proteccio -f database/migrations/20250922000000-add-reports-to-team-members.sql
psql -d Proteccio -f database/migrations/20250922000001-create-team-lead-member-views.sql
psql -d Proteccio -f database/migrations/20250922000002-fix-team-lead-admin-privileges.sql
psql -d Proteccio -f database/migrations/20250922000003-update-team-creation-functions.sql
psql -d Proteccio -f database/migrations/20250922000004-update-permission-functions.sql
psql -d Proteccio -f database/migrations/20250922000005-verify-team-lead-implementation.sql
```
