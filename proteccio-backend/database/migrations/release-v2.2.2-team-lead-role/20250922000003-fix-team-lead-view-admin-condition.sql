...
GRANT SELECT ON team_lead_managed_members TO Proteccio_user;
GRANT SELECT ON team_lead_member_stats TO Proteccio_user;
GRANT SELECT ON team_lead_member_performance TO Proteccio_user;
GRANT SELECT ON team_lead_time_logs TO Proteccio_user;
