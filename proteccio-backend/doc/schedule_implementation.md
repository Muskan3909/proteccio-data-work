...
**Migration file:** `Proteccio-backend/database/sql/migrations/add_member_time_off_table.sql`
...
**File:** `Proteccio-backend/src/controllers/schedule-v2/task-timeline-controller.ts`
...
**File:** `Proteccio-backend/src/controllers/schedule-v2/time-off-controller.ts`
...
**File:** `Proteccio-backend/src/socket.io/commands/on_schedule_task_drag_change.ts`
...
**File:** `Proteccio-frontend/src/api/schedule/scheduleApi.ts`
...
**File:** `Proteccio-frontend/src/components/schedule/task-timeline/TaskTimelineView.tsx`
...
**File:** `Proteccio-frontend/src/components/schedule/task-timeline/taskTransformers.ts`

```typescript
// Transforms Proteccio task data to gantt-task-react format
...
**File:** `Proteccio-frontend/src/pages/schedule/schedule.tsx`
...
**File:** `Proteccio-frontend/src/components/schedule/task-timeline/TimeOffCalendar.tsx`
...
**File:** `Proteccio-frontend/src/components/schedule/task-timeline/TaskTimelineFilters.tsx`
...
### Backend (Create)
1. `Proteccio-backend/src/controllers/schedule-v2/task-timeline-controller.ts` - Core task timeline logic
2. `Proteccio-backend/src/controllers/schedule-v2/time-off-controller.ts` - Time-off CRUD
3. `Proteccio-backend/src/socket.io/commands/on_schedule_task_drag_change.ts` - Real-time handler
4. `Proteccio-backend/database/sql/migrations/add_member_time_off_table.sql` - Database schema

### Frontend (Create)
5. `Proteccio-frontend/src/components/schedule/task-timeline/TaskTimelineView.tsx` - Main component
6. `Proteccio-frontend/src/components/schedule/task-timeline/taskTransformers.ts` - Data transformation
7. `Proteccio-frontend/src/components/schedule/task-timeline/TimeOffCalendar.tsx` - Time-off UI
8. `Proteccio-frontend/src/components/schedule/task-timeline/TaskTimelineFilters.tsx` - Filters UI

### Frontend (Modify)
9. `Proteccio-frontend/src/pages/schedule/schedule.tsx` - Add view toggle
10. `Proteccio-frontend/src/api/schedule/scheduleApi.ts` - Add RTK Query endpoints

### Backend (Modify)
11. `Proteccio-backend/src/routes/apis/gannt-apis/schedule-api-v2-router.ts` - Add routes
