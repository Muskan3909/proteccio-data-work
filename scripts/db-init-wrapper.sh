...
# Based on Proteccio's database initialization process

set -e

echo "========================================="
echo "Proteccio Database Initialization"
echo "========================================="
...
LATEST_BACKUP=$(find "$BACKUP_DIR" -name "Proteccio_backup_*.sql.gz" 2>/dev/null | sort -r | head -n 1)
...
# Initialize schema in correct order (based on Proteccio's 00_init.sh)
echo ""
