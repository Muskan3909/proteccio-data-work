...
const CACHE_NAMES = {
  STATIC: `Proteccio-static-${CACHE_VERSION}`,
  DYNAMIC: `Proteccio-dynamic-${CACHE_VERSION}`,
  API: `Proteccio-api-${CACHE_VERSION}`,
  IMAGES: `Proteccio-images-${CACHE_VERSION}`,
};
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(self.registration.showNotification('Proteccio', options));
});
