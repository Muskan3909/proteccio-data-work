...
export const SURVEY_EXCLUDED_ROUTES: string[] = [
  ...
  '/Proteccio/admin-center/billing',
  '/pricing',
  '/checkout',
  '/payment',
  ...
  '/register',
  // License related
  '/Proteccio/license-expired',
  // Unauthorized
  '/Proteccio/unauthorized',
];

// Routes where the survey popup IS allowed to appear
export const SURVEY_ALLOWED_ROUTES: string[] = ['/Proteccio/home', '/Proteccio/projects'];
