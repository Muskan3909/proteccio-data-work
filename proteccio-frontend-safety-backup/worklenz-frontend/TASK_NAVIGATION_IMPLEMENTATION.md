...
**File**: `Proteccio-frontend/src/features/task-drawer/task-drawer.slice.ts`
...
**File**: `Proteccio-frontend/src/components/task-drawer/task-drawer-navigation/task-drawer-navigation.tsx`
...
**File**: `Proteccio-frontend/src/components/task-drawer/task-drawer-header/task-drawer-header.tsx`
...
**File**: `Proteccio-frontend/src/utils/task-navigation-helper.ts`
...
**File**: `Proteccio-frontend/src/hooks/useTaskDrawerNavigation.ts`
...
**File**: `Proteccio-frontend/src/pages/home/task-list/TasksList.tsx`
...
**File**: `Proteccio-frontend/src/pages/projects/projectView/taskList/task-list-table/task-list-table.tsx`

- Added `handleOpenTask` callback
- Extracts task IDs using helper function
- Passes callback to TaskListTaskCell

**File**: `Proteccio-frontend/src/pages/projects/projectView/taskList/task-list-table/task-list-table-cells/task-list-task-cell/task-list-task-cell.tsx`
...
**File**: `Proteccio-frontend/public/locales/en/task-drawer/task-drawer.json`
