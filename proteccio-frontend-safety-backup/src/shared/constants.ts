...
export const LOGO_LIGHT =
  'https://s3.us-west-2.amazonaws.com/Proteccio.com/assets/Proteccio-light-mode.png';
export const LOGO_DARK =
  'https://s3.us-west-2.amazonaws.com/Proteccio.com/assets/Proteccio-dark-mode.png';
export const XMAS_LOGO_LIGHT =
  'https://s3.us-west-2.amazonaws.com/Proteccio.com/assets/Proteccio-xmas-light.webp';
export const XMAS_LOGO_DARK =
  'https://s3.us-west-2.amazonaws.com/Proteccio.com/assets/Proteccio-xmas-dark.webp';
