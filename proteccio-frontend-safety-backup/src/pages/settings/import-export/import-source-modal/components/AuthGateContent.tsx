    ...
    return (
      <div style={defaultContainerStyle}>
        ...
        <Typography.Paragraph style={{ color: themeToken.colorTextSecondary, marginBottom: 16 }}>
          {t(
            'auth.mondayBody',
            'Paste a personal access token to let Proteccio fetch boards and items for import.'
          )}
        </Typography.Paragraph>
        <Input.Password
    ...
    return (
      <div style={defaultContainerStyle}>
        ...
        <Typography.Paragraph style={{ color: themeToken.colorTextSecondary, marginBottom: 16 }}>
          {t(
            'auth.trelloBody',
            'Enter your Trello API key and token so Proteccio can fetch your boards.'
          )}
        </Typography.Paragraph>
        <Input
