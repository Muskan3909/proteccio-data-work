...
export const ImportSourceModal: React.FC<ImportSourceModalProps> = ({ open, onClose, source }) => {
  ...
  const [ProteccioStatuses, setProteccioStatuses] = React.useState<IProjectStatus[]>([]);

  // For Jira direct imports, default the target Proteccio project name to the selected Jira project name.
  ...
  const ProteccioFieldOptions = React.useMemo(
    () => [
      {
        value: 'key',
        ...
        if (Array.isArray(fieldsResp)) {
          ...
          setFieldMappingRows(
            (fieldsResp as Array<{
              ...
              ...row,
              // Default: include only "recommended" Proteccio fields (and any required fields).
  ...
  React.useEffect(() => {
    ...
    const fetchStatuses = async () => {
      ...
      if (!cancelled) {
        setProteccioStatuses(defaultWorkTypes);
            ...
            <>
              ...
              >
                <ImportStepContent
                  ...
                  ProteccioFieldOptions={ProteccioFieldOptions}
