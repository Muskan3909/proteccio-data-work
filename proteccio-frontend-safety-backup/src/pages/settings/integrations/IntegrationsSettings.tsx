      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <IntegrationCard
          ...
          description={t('teams.description', {
            defaultValue:
              'Integrate Microsoft Teams with your Proteccio team to receive real-time notifications, create tasks from Teams, and keep your team synchronized across both platforms.',
          })}
          available={false}
        />
