...
// Proteccio color palette - same as Labels
const ProteccioColorShades = {
  '#154c9b': [
    '#0D2A50',
    '#112E54',
    '#153258',
...
const ProteccioColorCodes = Object.values(ProteccioColorShades).flat();
...
const CategoriesDrawer = ({
  ...
  useEffect(() => {
    ...
    if (categoryId) {
      ...
      form.resetFields();
      form.setFieldsValue({ color_code: Object.keys(ProteccioColorShades)[0] });
    }
    ...
    >
      <div
        style={{
          width: 40,
          height: 40,
          backgroundColor: value || Object.keys(ProteccioColorShades)[0],
          borderRadius: 4,
          border: `1px solid ${token.colorBorder}`,
          cursor: 'pointer',
          transition: 'all 0.2s ease',
